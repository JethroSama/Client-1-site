...
const HeroImage = () => {
    return <div className='relative h-[30vh] md:h-[50vh] lg:h-[70vh]  '>
        ...
        <div className='absolute h-full w-full flex flex-col justify-center items-center'>
            ...
            <button className='bg-white py-2 px-5 text-purple-500 rounded-full shadow-md font-bold hover:shadow-lg active:scale-90 transition-all duration-150 mt-2 md:mt-5'>Music Sheets</button>
        </div>
    </div>
}
